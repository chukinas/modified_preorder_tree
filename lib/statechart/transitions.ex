defmodule Statechart.Transitions do
  ...
  # See `Statechart.Machine` for a stateful way of doing this.
  # In fact, `Statechart.Machine` just holds state and delegates out to this module.
  ...
  def transition(chart_spec, state, context, event) do
    # TODO this chart_spec makes me nervous. It should really just be statechart_module
    with chart <- chart_spec.__statechart__(),
