defmodule Statechart do
  ...
  """
  # TODO my main readme I think has it slightly wrong with the default
  # TODO keep the typespec?
  # TODO add doctest?
  # @spec statechart(Keyword.t(), any) :: any
  defmacro statechart(opts \\ [], do_block)

  defmacro statechart(opts, do: block) do
    ast = MacroStatechart.build_ast(block, opts)
  ...
  - TODO: on line 56, what other errors can arrise here?
